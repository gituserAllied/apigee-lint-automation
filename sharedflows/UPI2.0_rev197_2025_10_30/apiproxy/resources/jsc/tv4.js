...
*/
  (function(global, factory) {
      ...
      ValidatorContext.prototype.validateAll = function(data, schema, dataPathParts, schemaPathParts, dataPointerPath) {
          ...
          var frozenIndex, scannedFrozenSchemaIndex = null,
      ...
      ValidatorContext.prototype.validateArrayLength = function validateArrayLength(data, schema, dataPointerPath) {
          var error;
      ...
      var ErrorMessagesDefault = {
          ...
          // Array errors
          ARRAY_LENGTH_SHORT: "Array is too short ({length}), minimum {minimum} for {dataPointerPath}",
